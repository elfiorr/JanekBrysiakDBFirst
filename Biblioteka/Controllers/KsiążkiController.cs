...
namespace Biblioteka.Controllers
{
    public class KsiążkiController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TytułKsiążki,Opis,NumerWewKsiążki")] Książki książki)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TytułKsiążki,Opis,NumerWewKsiążki")] Książki książki)
        {
            if (ModelState.IsValid)
            {
